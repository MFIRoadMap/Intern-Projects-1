...
public class UrunBeans {
    ...
    public UrunBeans(String Urun_Barkod, String Urun_Marka, String Urun_Isim, String Urun_Stok, String Urun_Durum, String Urun_Fiyat, byte[] Image) {
        this.Urun_Barkod = Urun_Barkod;
        this.Urun_Marka = Urun_Marka;
        this.Urun_Isim = Urun_Isim;
        this.Urun_Stok = Urun_Stok;
